      ...
      <div className="main">
        ...
        {editRecord && (
          <div className="edit-panel">
            <h3>Edit Reproduction Record</h3>
            ...
            <input
              ...
              value={editRecord.inseminationDate || ""}
              onChange={handleChange}
            />
            ...
            <input
              type="date"
              name="pregnancyDate"
              value={editRecord.pregnancyDate || ""}
              onChange={handleChange}
            />
            ...
            <select
              ...
              value={editRecord.pregnancyStatus || ""}
              onChange={handleChange}
            >
            ...
            <input
              ...
              value={editRecord.lastCalvingDate || ""}
              onChange={handleChange}
            />
            ...
            <input
              type="date"
              name="gestationDate"
              value={editRecord.gestationDate || ""}
              onChange={handleChange}
            />
            ...
            <input
              ...
              value={editRecord.parturitionDate || ""}
              onChange={handleChange}
            />
...
export default ManageReproduction;